...
func TestMutator_Name(t *testing.T) {
	mutator := &Mutator{}
	if mutator.Name() != MutatorName {
		t.Errorf("Expected name '%s', got %s", MutatorName, mutator.Name())
	}
}

func TestMutator_CanMutate(t *testing.T) {
	mutator := &Mutator{}
...
func TestMutator_Apply(t *testing.T) {
	mutator := &Mutator{}
	...
	tests := []struct {
	...
	}{
		{
			...
			code: "x + y", // TODO: Update with actual test cases
			mutant: Mutant{
				Type:     "_binary", // TODO: Update with actual mutation type
